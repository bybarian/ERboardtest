        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-[#E8E4D9] rounded-2xl shadow-xs p-6 text-center space-y-4">
            ...
            <div className="bg-[#221D1A] px-6 py-8 rounded-2xl border-2 border-[#14110E] shadow-inner relative overflow-hidden">
              ...
              <span className={`text-[46px] font-mono leading-none tracking-widest block font-bold ${
                timeLeft < 180 ? "text-rose-500 animate-pulse" : "text-amber-400"
              }`}>
                {formatTimer(timeLeft)}
              </span>
              <div className="mt-2 text-[10px] text-slate-400 flex justify-center gap-3">
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                id="timer-toggle-btn"
                onClick={toggleTimer}
                className={`py-2 px-3 text-xs font-semibold rounded-lg flex items-center justify-center gap-1.5 transition-all text-white ${
              ...
              <button
                id="timer-reset-btn"
                onClick={resetTimer}
                className="py-2 px-3 text-xs font-semibold rounded-lg bg-[#F2F0EB] text-[#4A443F] hover:bg-[#E8E4D9] flex items-center justify-center gap-1.5 transition-all"
              >
              ...
              <div className="relative">
                <select
                  ...
                  value={timerPreset}
                  className="w-full py-2 px-2 text-xs font-semibold rounded-lg bg-[#F2F0EB] text-[#4A443F] border-none hover:bg-[#E8E4D9] cursor-pointer text-center"
                >
